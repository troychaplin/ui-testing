...
export declare const Nav: (({ navType, children }: NavWrapperProps) => import("react/jsx-runtime").JSX.Element) & {
    ...
    Aside: {
        ({ menu, LoggedInUser, LoggedOutUser, LoggedMenu, userNoImage, children, }: import("./NavAside").NavAsideProps | import("./NavAside").NavAsideLoggedInProps | import("./NavAside").NavAsideLoggedOutProps): import("react/jsx-runtime").JSX.Element;
        displayName: string;
    };
    Primary: {
        ({ children }: {
